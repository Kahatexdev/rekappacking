            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <ul>
                            <li>Data Produksi lipat = Outflow lipat di ERP</li>
                        </ul>
                        <br>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 pl-0 pr-4">
                        ...
                        <form action="<?= base_url('packing/importproduksiLipat') ?>" method="post" enctype="multipart/form-data">
