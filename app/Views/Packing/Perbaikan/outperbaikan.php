            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <ul>
                            <li>Data Out out perbaikan = Outflow out perbaikan di ERP</li>
                        </ul>
                        <br>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 pl-0 pr-4">
                        ...
                        <form action="<?= base_url('packing/importoutperbaikan') ?>" method="post" enctype="multipart/form-data">
