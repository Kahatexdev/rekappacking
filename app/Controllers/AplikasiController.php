...
class AplikasiController extends BaseController
{
    ...
    {
        $dataProduksi = $this->prodModel->getAplikasiProduksi();
        ...
        $data = [
            'Judul' => 'Data Produksi Aplikasi',
            'User' =>  session()->get('username'),
            'Tabel' => 'Data Produksi Aplikasi',
            'Data' => $dataJoined
        ];

        return view('Packing/Aplikasi/aplikasi', $data);
    }
    ...
    public function exportAplikasi($selectedIds)
    {
        ...
        $pdf->Cell(0, 10, 'Export Data Produksi Aplikasi', 0, 1, 'C');
        ...
        $nama = 'export Data Produksi Aplikasi';
