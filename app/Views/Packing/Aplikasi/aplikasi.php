            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <ul>
                            <li>Data Produksi aplikasi = Outflow aplikasi di ERP</li>
                        </ul>
                        <br>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 pl-0 pr-4">
                        ...
                        <form action="<?= base_url('packing/importproduksiaplikasi') ?>" method="post" enctype="multipart/form-data">
...
<script>
    ...
    function exportSelected() {
        ...
        var url = '<?= base_url('export/aplikasi'); ?>';
