...
class GudangController extends BaseController
{
    public function outgudang()
    {
        ...
        $data = [
            'Judul' => 'Data OutGudang',
            'User' =>  session()->get('username'),
            'Tabel' => 'Data OutGudang',
            'Data' => $dataJoined
        ];

        return view('Packing/Gudang/outgudang', $data);
    }
    ...
    public function exportOutGudang($selectedIds)
    {
        ...
        $pdf->SetTitle('Export Data Out Gudang ');
        $pdf->SetSubject('Export Data Out Gudang ');
        $pdf->SetKeywords('Export Data Out Gudang ');
        ...
        $pdf->Cell(0, 10, 'Export Data Out Gudang', 0, 1, 'C');
