            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <ul>
                            <li>Data Produksi obras = Outflow obras di ERP</li>
                        </ul>
                        <br>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 pl-0 pr-4">
                        ...
                        <form action="<?= base_url('packing/importproduksiobras') ?>" method="post" enctype="multipart/form-data">
